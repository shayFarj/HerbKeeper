...
STATUS_ALPHA_REWARD = (1/MIN_STATUS_HERB - 1/MAX_STATUS_REWARD) / (MAX_D- HERB_RADIUS - SPACESHIP_RADIUS)
STATUS_ALPHA_PUNISH = (1/MIN_STATUS_BOUN - 1/MAX_STATUS_PUNISH) / (MAX_D/12- BOUNCER_RADIUS - SPACESHIP_RADIUS)
